 ...
 */
class Bestmagento_Magemenu_Block_Navigation extends Mage_Core_Block_Template
{
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        if (!empty($htmlChildren)) {
            if ($level==0) {
				$html[]= '<div class="menu children'.$childrenCount.'">';
            ...
            if ($childrenWrapClass) {
		     ...
		     if ($level==0) {
				...
				$html[]= '<div class="clear"></div></div></div></div></div></div></div>';
